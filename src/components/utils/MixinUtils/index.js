...
export const tablet = `@media (min-width: ${TABLET_MIN_WIDTH}px) and (max-width: ${
  DESKTOP_MIN_WIDTH - 1
}px)`

export const mdDesktop = `@media (min-width: ${DESKTOP_MIN_WIDTH}px) and (max-width: ${
  LG_DESKTOP_MIN_WIDTH - 1
}px)`
